...
module ReferenceExtractor
  module Internal
    class AssociationInspectorTest < Minitest::Test
      ...
      test "excludes default factory paths" do
        node = parse("has_one :order")
        inspector = AssociationInspector.new
      ...
      test "respects glob patterns in excluded_files" do
        node = parse("has_one :order")
        inspector = AssociationInspector.new(excluded_files: Set["app/serializers/**/*.rb"])
